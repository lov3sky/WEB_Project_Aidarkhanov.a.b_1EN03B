<?php 
    ...
    $query = "SELECT * FROM usersrab WHERE type=1";
    $res = $con->query($query);
    $row = $res->fetch_array();
    $sql = "SELECT * FROM userssos WHERE type=2";
    $result = $con->query($sql);
    $col = $result->fetch_array();
    $numb1 = mysqli_num_rows($res);
            ...
            <div class="col-lg-12 col-xs-12">
                <div class="statistics">
                    ...
                    <?php 
                     ...
                     ?>
                    <div class="col-lg-6 col-xs-12">
                        <p id="aaa">Зарегистрировались <?php echo $numb1+$numb2;?> пользователя(ей). Из них <?php echo $numb1; ?> работодателя(ей) и <?php echo $numb2; ?> соискателя(ей).</p><br>
                        <p id="bbb">На сайте <?php echo $numb1; ?> компания(и) и <?php echo $numb2; ?> резюме.</p><br>
